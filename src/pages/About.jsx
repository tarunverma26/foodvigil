    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-10">
      ...
      <div className="text-center space-y-3 max-w-2xl mx-auto p-6 sm:p-8 rounded-3xl bg-white/95 backdrop-blur-md border border-[#E8DCB8] shadow-sm">
        <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-[#EAF5EE] text-[#1F5D42] text-xs font-bold border border-[#BCE2CB]">
          <ShieldCheck className="w-3.5 h-3.5 text-[#246B4A]" />
      ...
      <div className="card-surface p-6 sm:p-8 space-y-4">
        ...
        <div className="p-4 bg-emerald-50/60 border border-emerald-200 rounded-xl text-xs font-bold text-forest-900 text-center tracking-wide">
      ...
      <div className="card-surface p-6 sm:p-8 space-y-6">
        <h2 className="font-display font-bold text-lg text-forest-900 flex items-center gap-2">
          <Scale className="w-5 h-5 text-forest-800" />
          <span>Trust & Safety Principles</span>
        </h2>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
          
          <div className="p-4 bg-brand-bg/40 rounded-xl border border-brand-border space-y-1.5">
            <h3 className="font-bold text-brand-text flex items-center gap-1.5">
      ...
      <div className="p-6 bg-forest-900 text-white rounded-3xl space-y-3 text-xs leading-relaxed border border-forest-800">
        <h3 className="font-bold text-sm text-brand-orange uppercase tracking-wider">
          Statutory Regulatory Notice
        </h3>
        <p className="text-emerald-100/90 leading-relaxed">
          FoodVigil is an independent open educational project. It is not affiliated with or endorsed directly by the Food Safety and Standards Authority of India (FSSAI) or the Ministry of Consumer Affairs. For formal administrative licensing, please visit <a href="https://foscos.fssai.gov.in" target="_blank" rel="noopener noreferrer" className="text-brand-orange underline font-bold">foscos.fssai.gov.in</a>.
        </p>
      </div>
